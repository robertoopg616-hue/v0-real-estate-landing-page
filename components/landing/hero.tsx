      ...
      <section className="relative min-h-screen flex items-center pt-16 overflow-hidden bg-secondary">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-8 md:px-16 py-20 md:py-24 z-10 w-full">
          <div className="max-w-4xl text-left space-y-6 opacity-0">
            <h1 className="font-normal tracking-wide text-[42px] sm:text-5xl md:text-7xl lg:text-8xl leading-[1.1] text-neutral-900 md:text-white font-headline max-w-3xl normal-case">
        ...
        <div className="max-w-4xl text-left space-y-6">
          ...
          <div className="overflow-hidden py-1">
            <motion.h1
              ...
              initial="initial"
              animate="animate"
              className="font-normal tracking-wide text-[42px] sm:text-5xl md:text-7xl lg:text-8xl leading-[1.1] text-neutral-900 md:text-white font-headline max-w-3xl normal-case"
            >
              Your Next Home. Perfectly Timed.
            </motion.h1>
          </div>
