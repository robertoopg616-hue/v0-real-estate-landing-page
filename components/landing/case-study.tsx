...
function BeforeAfterComparison() {
  ...
  return (
    <div 
      ref={containerRef}
      className="relative w-full aspect-[16/10] sm:aspect-[16/9] rounded-2xl overflow-hidden shadow-2xl border border-primary/20"
      onMouseMove={(e) => {
    ...
    >
      ...
      >
        ...
        <div className="max-w-md my-auto space-y-3 z-10 glass-card p-6 rounded-xl border border-primary/10 bg-white/60">
          <h4 className="text-2xl sm:text-3xl font-bold text-secondary font-sans leading-tight">Cramped & Cluttered Condo</h4>
      ...
      >
        ...
        <div className="max-w-md my-auto space-y-3 z-10 glass-card p-6 rounded-xl border border-primary/20 bg-white/70 shadow-lg">
          <h4 className="text-2xl sm:text-3xl font-bold text-secondary font-sans leading-tight">Premium, Lit & Beautiful Vibe</h4>
          <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
      ...
      >
        {/* Slider Handle */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-primary border-4 border-background shadow-2xl flex items-center justify-center cursor-ew-resize select-none group">
    ...
    <section className="py-24 md:py-32 bg-muted/30 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          >
            {/* Challenge Card */}
            <div className="glass-card p-6 rounded-2xl shadow-figma-card border border-primary/20 space-y-3 bg-white">
              <div className="flex items-center gap-2 text-red-500 font-bold text-sm">
                <HelpCircle className="size-5 shrink-0" />
                The Challenge
              </div>
              <h3 className="text-xl font-bold text-secondary font-sans">Sarah & David&apos;s Upsizing Anxiety</h3>
            ...
            {/* Results Card */}
            <div className="glass-card p-6 rounded-2xl border border-primary/30 shadow-figma-card space-y-3 bg-white">
              <div className="flex items-center gap-2 text-primary font-bold text-sm">
                <CheckCircle className="size-5 shrink-0" />
                The Solution & Result
              </div>
              <h3 className="text-xl font-bold text-secondary font-sans">Synchronized Move & $45,000 Gain</h3>
