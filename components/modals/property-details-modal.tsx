        ...
        <>
          ...
          >
            <div 
              ...
              className="glass-card w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-2xl border border-primary/25 shadow-2xl relative flex flex-col bg-white scrollbar-thin cursor-default pt-[72px]"
            >
              ...
              <div className="absolute top-0 left-0 right-0 h-[72px] border-b border-neutral-100 bg-neutral-50/50 flex items-center px-6 md:px-8 z-40">
                <span className="text-xs font-bold text-secondary uppercase tracking-widest font-sans">Property Overview</span>
              </div>
